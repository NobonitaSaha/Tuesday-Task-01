...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Delay uploading content after 2 seconds
    setTimeout(function () {
        // Your code to upload content here
        console.log("Content uploaded after 2 seconds");
    }, 4000);
});
...
function acceptCookies() {
    ...
    const overlay = document.querySelector('#cookiePopup');
