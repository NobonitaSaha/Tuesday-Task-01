...
//    }
    ...
    return constant('DEV_MODE') && DEV_MODE;
}
...
function getOffersFromCsv()
{
    ...
    $pos = 0;
    foreach ($rows as $row) {
        list($enabled, $name, $url, $image, $bonus, $forwardParams) = $row;
        ...
        $offers[] = compact('pos', 'name', 'url', 'image', 'bonus', 'forwardParams');
    }
